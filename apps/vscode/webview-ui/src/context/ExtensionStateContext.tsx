...
export interface ExtensionStateContextType extends ExtensionState {
	...
	setShowBmsAutosarWizard: (value: boolean) => void
	...
	navigateToBmsAutosarWizard: () => void
...
export const ExtensionStateContextProvider: React.FC<{
	...
	const [showBmsAutosarWizard, setShowBmsAutosarWizard] = useState(false)
	...
	const navigateToHistory = useCallback(() => {
		...
		setShowBmsAutosarKnowledgeGraph(false)
		setShowHistory(true)
	}, [setShowSettings, closeMcpView, setShowAccount, setShowWorktrees, setShowHistory, setShowBmsAutosarWizard, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])
	...
	const navigateToAccount = useCallback(() => {
		...
		setShowBmsAutosarKnowledgeGraph(false)
		setShowAccount(true)
	}, [setShowSettings, closeMcpView, setShowHistory, setShowWorktrees, setShowAccount, setShowBmsAutosarWizard, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])
	...
	}, [setShowSettings, closeMcpView, setShowHistory, setShowAccount, setShowBmsAutosarWizard, setShowWorktrees, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])

	const navigateToBmsAutosarWizard = useCallback(() => {
		setShowSettings(false)
		closeMcpView()
		setShowHistory(false)
		setShowAccount(false)
		...
		setShowBmsAutosarQualityReport(false)
		setShowBmsAutosarKnowledgeGraph(false)
		setShowBmsAutosarWizard(true)
	}, [setShowSettings, closeMcpView, setShowHistory, setShowAccount, setShowWorktrees, setShowBmsAutosarWizard, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])

	const navigateToBmsAutosarQualityReport = useCallback(() => {
		setShowSettings(false)
		closeMcpView()
		setShowHistory(false)
		setShowAccount(false)
		...
		setShowBmsAutosarWizard(false)
		setShowBmsAutosarKnowledgeGraph(false)
		setShowBmsAutosarQualityReport(true)
	}, [setShowSettings, closeMcpView, setShowHistory, setShowAccount, setShowWorktrees, setShowBmsAutosarWizard, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])

	const navigateToBmsAutosarKnowledgeGraph = useCallback(() => {
		setShowSettings(false)
		closeMcpView()
		setShowHistory(false)
		setShowAccount(false)
		...
		setShowBmsAutosarWizard(false)
		setShowBmsAutosarQualityReport(false)
		setShowBmsAutosarKnowledgeGraph(true)
	}, [setShowSettings, closeMcpView, setShowHistory, setShowAccount, setShowWorktrees, setShowBmsAutosarWizard, setShowBmsAutosarQualityReport, setShowBmsAutosarKnowledgeGraph])

	const openBmsAutosarCompileManager = useCallback(() => {
		setShowSettings(false)
		closeMcpView()
		setShowHistory(false)
		setShowAccount(false)
	...
	const bmsAutosarQualityReportUnsubscribeRef = useRef<(() => void) | null>(null)
	...
	useEffect(() => {
		...
		bmsAutosarQualityReportUnsubscribeRef.current = UiServiceClient.subscribeToBmsAutosarQualityReport(
			EmptyRequest.create({}),
			{
				onResponse: () => {
					console.log("[DEBUG] Received BMS AUTOSAR quality report event from gRPC stream")
					navigateToBmsAutosarQualityReport()
				},
				onError: (error) => {
					console.error("Error in BMS AUTOSAR quality report subscription:", error)
				},
				onComplete: () => {
					console.log("BMS AUTOSAR quality report subscription completed")
				},
			},
		)

		// Subscribe to BMS AUTOSAR knowledge graph open events
		bmsAutosarKnowledgeGraphUnsubscribeRef.current = UiServiceClient.subscribeToBmsAutosarKnowledgeGraph(
			EmptyRequest.create({}),
			{
				onResponse: () => {
					console.log("[DEBUG] Received BMS AUTOSAR knowledge graph event from gRPC stream")
					navigateToBmsAutosarKnowledgeGraph()
				},
				onError: (error) => {
					console.error("Error in BMS AUTOSAR knowledge graph subscription:", error)
				},
				onComplete: () => {
					console.log("BMS AUTOSAR knowledge graph subscription completed")
				},
			},
		)

		// Subscribe to BMS AUTOSAR compile manager open events
		bmsAutosarCompileUnsubscribeRef.current = UiServiceClient.subscribeToBmsAutosarCompile(
			EmptyRequest.create({}),
			{
				onResponse: () => {
					console.log("[DEBUG] Received BMS AUTOSAR compile event from gRPC stream")
					openBmsAutosarCompileManager()
				},
				onError: (error) => {
					console.error("Error in BMS AUTOSAR compile subscription:", error)
				},
				onComplete: () => {
					console.log("BMS AUTOSAR compile subscription completed")
				},
			},
		)

		// Subscribe to BMS AUTOSAR generator (wizard) open events
		bmsAutosarGeneratorUnsubscribeRef.current = UiServiceClient.subscribeToBmsAutosarGenerator(
			EmptyRequest.create({}),
			{
				onResponse: () => {
					console.log("[DEBUG] Received BMS AUTOSAR generator event from gRPC stream")
					navigateToBmsAutosarWizard()
				},
				onError: (error) => {
					console.error("Error in BMS AUTOSAR generator subscription:", error)
				},
				onComplete: () => {
					console.log("BMS AUTOSAR generator subscription completed")
				},
			},
		)
		...
		return () => {
			...
			if (bmsAutosarQualityReportUnsubscribeRef.current) {
				bmsAutosarQualityReportUnsubscribeRef.current()
				bmsAutosarQualityReportUnsubscribeRef.current = null
			}
			if (bmsAutosarKnowledgeGraphUnsubscribeRef.current) {
				bmsAutosarKnowledgeGraphUnsubscribeRef.current()
				bmsAutosarKnowledgeGraphUnsubscribeRef.current = null
			}
			if (bmsAutosarCompileUnsubscribeRef.current) {
				bmsAutosarCompileUnsubscribeRef.current()
				bmsAutosarCompileUnsubscribeRef.current = null
			}
			if (bmsAutosarGeneratorUnsubscribeRef.current) {
