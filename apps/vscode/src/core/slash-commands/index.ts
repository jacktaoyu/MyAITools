...
export async function parseSlashCommands(
	...
	const SUPPORTED_DEFAULT_COMMANDS = ["newtask", "smol", "compact", "newrule", "reportbug", "deep-planning", "explain-changes", "bms-autosar"]
	...
	const commandReplacements: Record<string, string> = {
		...
		"bms-autosar": bmsAutosarToolResponse(),
	}
