...
import { bms_autosar_generate_variants } from "./bms_autosar_generate"
import { bms_autosar_knowledge_variants } from "./bms_autosar_knowledge"
...
export function registerClineToolSets(): void {
	...
	const allToolVariants = [
		...
		...bms_autosar_generate_variants,
		...bms_autosar_knowledge_variants,
